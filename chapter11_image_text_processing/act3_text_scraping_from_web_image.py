...
# 가끔 팬텀JS가 아 페이지에 있는 요소를 찾아내지 못할 때가 있습니다.
# 그럴 경우 다음 행의 주석을 제거해서 셀레니움 대신 크롬드라이버를 쓰세요.
driver = webdriver.Chrome(executable_path=r"C:\Program Files\chromedriver_win32\chromedriver.exe")

driver.get("http://amazon.com/Alice-Wonderland-Large-Lewis-Carroll/dp/145155558X")
time.sleep(2)
